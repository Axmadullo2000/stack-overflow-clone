...
const SocialMedia = ({ type }) => {
  return (
    <div className="login__sm-buttons ">
      <button className="login__sm-button google">
        <svg
          aria-hidden="true"
      ...
      <button className="login__sm-button github">
        <svg
          aria-hidden="true"
      ...
      <button className="login__sm-button facebook">
        <svg
          aria-hidden="true"
